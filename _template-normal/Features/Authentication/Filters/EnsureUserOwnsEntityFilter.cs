...
using TemplateNormal.Common.Api.Results;
using TemplateNormal.Common.Data;
using TemplateNormal.Features.Authentication;

namespace TemplateNormal.Features.Authentication.Filters;

public class EnsureUserOwnsEntityFilter<TRequest, TEntity>(SqlDbContext database, Func<TRequest, int> idSelector) : IEndpointFilter
